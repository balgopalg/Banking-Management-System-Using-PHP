...
<body>
    <nav class="navbar">
        <div class="profile-nav">
            ...
            <div class="profile">
                ...
                <div class="dropdown">
                    <img src="/banking/images/<?php echo "$img"; ?>" class="users" alt="">
                    <div class="items">
    ...
    <div class="bottom-nav">
        ...
        <div>
            ...
            <div class="tooltip">
                <a href="/banking/components/extra/faqs.php">
                    <button>
            ...
            <div class="account-main">
                ...
                <div class="account-summary">
                    ...
                    <div class="quick-transfer">
                        ...
                        <form action="" method="post">
                            <div>
                                Send &nbsp;<i class="fa-solid fa-indian-rupee-sign"></i> <input type="number" name="amount" id="amount" placeholder="Enter amount" required> To
