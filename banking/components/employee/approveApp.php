...
$get_pending=mysqli_fetch_assoc(mysqli_query($conn,"SELECT COUNT(*) as count FROM customers WHERE Status='Pending'"))['count'];
    ...
    <nav class="navbar">
        <div class="profile-nav">
            ...
            <div class="profile">
                ...
                <div class="dropdown">
                    <img src="/banking/images/clerk.jpg" alt="">
                    <div class="items">
                        <a href="/banking/assets/php/logout.php">Logout</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <main>
        ...
        <div class="table">
            <table id="myTable" class="styled-table">
                ...
                <tbody>
                    <?php
                    $result = mysqli_query($conn, "SELECT * FROM customers WHERE Status='Pending'");
...
if (isset($_POST['reject'])) {
    ...
    $prev_image_query = mysqli_query($conn, "SELECT `img` FROM customers WHERE Email='$email'");
        if ($prev_image_query && mysqli_num_rows($prev_image_query) > 0) {
            ...
            $prev_image_path = $_SERVER['DOCUMENT_ROOT'] . "/banking/images/" . $prev_image_name;
