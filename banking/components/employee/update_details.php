...
if (isset($_POST['updatepic'])) {
    ...
    if (in_array($img_ext, $allowed_extensions) && $img['error'] === UPLOAD_ERR_OK) {
        ...
        $upload_directory = "banking/images/";
...
if (isset($_POST['deleteAccount'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM loanapp WHERE customerAccountNo=$accountNo")) > 0) {
        ...
        window.location.href = '/banking/components/employee/clerk_dashboard.php';
        </script>";
            exit;
        }
    }
