    ...
    <main class="clogin-main">
        <div class="wrapper">
            <section class="form signup">
                <form action="" method="post" enctype="multipart/form-data" onkeypress="return disableEnterKey(event)" autocomplete="off" onsubmit="return validateCaptcha()">
                    ...
                    <div class="page" id="page3">
                        ...
                        <script>
                            async function lookupPincode() {
                                ...
                                const response = await fetch(`/banking/assets/php/lookup.php?code=${pincode}`);
                                const data = await response.json();
                                if (data.district && data.state) {
                                    document.getElementById('district').value = data.district;
                                    document.getElementById('state').value = data.state;
                                } else {
                                    document.getElementById('error').innerHTML = "Enter valid pincode";
                                    setTimeout(() => {
                    ...
                    <div class="page" id="page5">
                        ...
                        <div class="captcha-container">
                            <div class="field input">
                                <input type="text" name="captcha" id="captcha" style="width: 100px;" readonly>
                            </div>
                            <div class="input-captcha">
                                <div class="field input">
                                    <input type="text" name="usercaptcha" id="userCaptcha" placeholder="Enter captcha">
                                </div>
                                <i class="fa-solid fa-arrows-rotate" id="refreshCaptcha"></i>
                            </div>
                        </div>
...
if (isset($_POST['submit'])) {
    ...
    if ($captcha != $usercaptcha) {
        $err = "it seems there was an issue with the entered captcha. Please try again !!";
    } else {
        require $_SERVER['DOCUMENT_ROOT'] . "/banking/assets/php/config.php";
